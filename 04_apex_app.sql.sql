...
,p_release=>'26.1.3'
,p_default_workspace_id=>149255000430091076437
,p_default_application_id=>63041
,p_default_id_offset=>0
,p_default_owner=>'WKSP_CSIEWORKSPACE'
);
end;
/
 
prompt APPLICATION 63041 - Gestionarea Bugetului Personal
--
-- Application Export:
--   Application:     63041
--   Name:            Gestionarea Bugetului Personal
--   Date and Time:   20:21 Tuesday September 15, 2026
--   Exported By:     PLAMUTIELENA24@STUD.ASE.RO
--   Flashback:       0
...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'WKSP_CSIEWORKSPACE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Gestionarea Bugetului Personal')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'PERSONAL-BUDGET-MANAGER')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'19AE5FED85A1721619C19EE104098AD5D3B16D320CDC7E4DB1CFB3C6B2A1A1E5'
...
,p_authentication_id=>wwv_flow_imp.id(165087585361382204755)
,p_application_tab_set=>0
,p_logo_type=>'T'
,p_logo_text=>'Personal Budget Manager'
...
,p_substitution_value_01=>'Personal Budget Manager'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260507152947Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_last_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_file_prefix=>nvl(wwv_flow_application_install.get_static_app_file_prefix,'')
,p_files_version=>6
,p_version_scn=>'15766854004189'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(165087586193412204757)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2467739217141810545
,p_nav_list_template_options=>'#DEFAULT#:t-TreeNav--styleA:js-navCollapsed--hidden'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(165087587327588204759)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087580811871204752)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>'15764645876535'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087581152412204753)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'display_as', 'POPUP',
  'mode', 'FULL')).to_clob
,p_version_scn=>'15764645876536'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087581479193204753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087581773726204753)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087582025433204753)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_SELECT_MANY'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'display_values_as', 'separated')).to_clob
,p_version_scn=>'15764645876539'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087582304864204753)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_SINGLE_CHECKBOX'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'checked_value', 'Y',
  'unchecked_value', 'N')).to_clob
,p_version_scn=>'15764645876549'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087582654297204754)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_STAR_RATING'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'default_icon', 'fa-star',
  'tooltip', '#VALUE#')).to_clob
,p_version_scn=>'15764645876550'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087582908050204754)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087583250699204754)
,p_plugin_type=>'PROCESS TYPE'
,p_plugin=>'NATIVE_GEOCODING'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'match_mode', 'RELAX_HOUSE_NUMBER')).to_clob
,p_version_scn=>'15764645876552'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087583563907204754)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'include_slider', 'Y')).to_clob
,p_version_scn=>'15764645876556'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087583867458204754)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'actions_menu_structure', 'IG')).to_clob
,p_version_scn=>'15764645876560'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087584165632204754)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_MAP_REGION'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'use_vector_tile_layers', 'Y')).to_clob
,p_version_scn=>'15764645876565'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087584441231204755)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>'15764645876574'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(165087584750753204755)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>'15764645876577'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(165087587327588204759)
,p_name=>'Navigation Bar'
,p_static_id=>'navigation-bar'
,p_version_scn=>'15764645876965'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(165087599426768204779)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(165087599910499204779)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'---'
,p_static_id=>'list_item'
,p_list_item_link_target=>'separator'
,p_list_item_disp_cond_type=>'USER_IS_NOT_PUBLIC_USER'
,p_parent_list_item_id=>wwv_flow_imp.id(165087599426768204779)
,p_list_item_current_type=>'TARGET_PAGE'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(165087600339836204779)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(165087586193412204757)
,p_name=>'Navigation Menu'
,p_static_id=>'navigation-menu'
,p_version_scn=>'15766853847669'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260507152633Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(166851482890320967477)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Administrare Sistem'
,p_static_id=>'administrare-sistem'
,p_list_item_link_target=>'f?p=&APP_ID.:4:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-archive'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'4'
,p_created_on=>wwv_flow_imp.dz('20260507152633Z')
,p_updated_on=>wwv_flow_imp.dz('20260507152633Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(166572660378052627934)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>unistr('Istoric Tranzac\021Bii')
,p_static_id=>unistr('istoric-tranzac\021Bii')
,p_list_item_link_target=>'f?p=&APP_ID.:2:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-history'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'2'
,p_created_on=>wwv_flow_imp.dz('20260506205210Z')
,p_updated_on=>wwv_flow_imp.dz('20260506205210Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(166796762991750865924)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>unistr('Monitorizare Tranzac\021Bii Clien\021Bi')
,p_static_id=>unistr('monitorizare-tranzac\021Bii-clien\021Bi')
,p_list_item_link_target=>'f?p=&APP_ID.:3:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-credit-card'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'3'
,p_created_on=>wwv_flow_imp.dz('20260507122258Z')
,p_updated_on=>wwv_flow_imp.dz('20260507122258Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(165089889315194290454)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Tablou de Bord'
,p_static_id=>'tablou-de-bord'
,p_list_item_link_target=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-combo-chart'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'1'
,p_created_on=>wwv_flow_imp.dz('20260501141234Z')
,p_updated_on=>wwv_flow_imp.dz('20260501141234Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
end;
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(165087588772872204763)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(165087589096234204764)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(165087589373484204765)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(165087588477806204763)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(165087589613928204765)
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(165087590904402204766)
...
/
prompt --application/shared_components/user_interface/lovs/categorii_denumire
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(166572664068232628041)
,p_lov_name=>'CATEGORII.DENUMIRE'
,p_static_id=>'categorii-denumire'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
...
,p_version_scn=>'15766630789635'
,p_created_on=>wwv_flow_imp.dz('20260506205211Z')
,p_updated_on=>wwv_flow_imp.dz('20260506205211Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
end;
/
prompt --application/shared_components/user_interface/lovs/utilizatori_nume
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(166572663850053628041)
,p_lov_name=>'UTILIZATORI.NUME'
,p_static_id=>'utilizatori-nume'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'UTILIZATORI'
,p_return_column_name=>'ID_UTILIZATOR'
,p_display_column_name=>'NUME'
,p_default_sort_column_name=>'NUME'
,p_default_sort_direction=>'ASC'
,p_version_scn=>'15766630789626'
,p_created_on=>wwv_flow_imp.dz('20260506205211Z')
,p_updated_on=>wwv_flow_imp.dz('20260506205211Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(165087591251947204767)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(165087585611101204756)
,p_name=>'Breadcrumb'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(166851483793303967478)
,p_short_name=>'Administrare Sistem'
,p_static_id=>'administrare-sistem'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(166572661226285627936)
,p_short_name=>unistr('Istoric Tranzac\021Bii')
,p_static_id=>unistr('istoric-tranzac\021Bii')
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(166796763878843865926)
,p_short_name=>unistr('Monitorizare Tranzac\021Bii Clien\021Bi')
,p_static_id=>unistr('monitorizare-tranzac\021Bii-clien\021Bi')
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(165089890292055290456)
,p_short_name=>'Tablou de Bord'
,p_static_id=>'tablou-de-bord'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(165087586504829204757)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(165087585007885204755)
,p_build_option_name=>'Commented Out'
,p_static_id=>'commented-out'
,p_build_option_status=>'EXCLUDE'
,p_version_scn=>'15764645876578'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(165087585361382204755)
,p_name=>'Oracle APEX Accounts'
,p_static_id=>'oracle-apex-accounts'
,p_scheme_type=>'NATIVE_APEX_ACCOUNTS'
,p_use_secure_cookie_yn=>'N'
,p_ras_mode=>0
,p_version_scn=>'15764645876579'
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_last_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
end;
...
wwv_flow_imp_page.create_page(
 p_id=>1
,p_name=>'Home'
,p_alias=>'TABLOU-DE-BORD'
,p_step_title=>'Tablou de Bord'
,p_autocomplete_on_off=>'OFF'
...
,p_created_on=>wwv_flow_imp.dz('20260501141234Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260506203840Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_last_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165089889707973290455)
...
,p_menu_id=>wwv_flow_imp.id(165087585611101204756)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165089890408431290456)
,p_plug_name=>'Cheltuieli pe Categorii'
,p_static_id=>'cheltuieli-pe-categorii'
,p_title=>'Cheltuieli pe Categorii'
...
,p_plug_query_headings_type=>'COLON_DELMITED_LIST'
,p_created_on=>wwv_flow_imp.dz('20260501141234Z')
,p_updated_on=>wwv_flow_imp.dz('20260506202429Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(165089890836835290457)
,p_region_id=>wwv_flow_imp.id(165089890408431290456)
,p_chart_type=>'pie'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(165089892682122290459)
,p_chart_id=>wwv_flow_imp.id(165089890836835290457)
,p_static_id=>'series'
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT c.denumire as categorie, ',
'       SUM(ch.suma) as total',
'FROM cheltuieli ch',
'JOIN categorii c ON ch.id_categorie = c.id_categorie',
'GROUP BY c.denumire'))
,p_max_row_count=>20
,p_items_value_column_name=>'TOTAL'
,p_items_label_column_name=>'CATEGORIE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165089893227320290459)
,p_plug_name=>unistr('Evolu\021Bie lunar\0103')
,p_static_id=>unistr('evolu\021Bie-lunar\0103')
,p_title=>unistr('Evolu\021Bie lunar\0103')
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_escape_on_http_output=>'N'
,p_plug_template=>4072358936313175081
...
,p_plug_query_headings_type=>'COLON_DELMITED_LIST'
,p_created_on=>wwv_flow_imp.dz('20260501141234Z')
,p_updated_on=>wwv_flow_imp.dz('20260506203705Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(165089893613894290460)
,p_region_id=>wwv_flow_imp.id(165089893227320290459)
,p_chart_type=>'line'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(165089894122389290460)
,p_chart_id=>wwv_flow_imp.id(165089893613894290460)
,p_static_id=>'series'
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT TO_CHAR(data_cheltuiala, ''DD-MON'') as ziua, ',
'       SUM(suma) as total_zi,',
'       TRUNC(data_cheltuiala) as data_sort ',
'FROM cheltuieli',
'GROUP BY TO_CHAR(data_cheltuiala, ''DD-MON''), TRUNC(data_cheltuiala)',
'ORDER BY data_sort'))
,p_max_row_count=>20
,p_items_value_column_name=>'TOTAL_ZI'
,p_items_label_column_name=>'ZIUA'
,p_line_style=>'solid'
,p_line_type=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(165881958909722419502)
,p_chart_id=>wwv_flow_imp.id(165089893613894290460)
,p_static_id=>'x'
,p_axis=>'x'
,p_is_rendered=>'on'
...
,p_created_on=>wwv_flow_imp.dz('20260504191940Z')
,p_updated_on=>wwv_flow_imp.dz('20260504191940Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(165881959048682419503)
,p_chart_id=>wwv_flow_imp.id(165089893613894290460)
,p_static_id=>'y'
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165881958888190419501)
,p_plug_name=>'New'
,p_static_id=>'new'
,p_title=>unistr('Sistem de Gestiune Finan\021Be Personale')
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_plug_header=>unistr('Bine a\021Bi venit! Mai jos ave\021Bi situa\021Bia financiar\0103 actualizat\0103 \00EEn timp real.')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260504191702Z')
,p_updated_on=>wwv_flow_imp.dz('20260504191719Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165089894783542290461)
,p_plug_name=>unistr('Tipuri de tranzac\021Bi')
,p_static_id=>unistr('tipuri-de-tranzac\021Bi')
,p_title=>unistr('Tipuri de tranzac\021Bi')
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_escape_on_http_output=>'N'
,p_plug_template=>4072358936313175081
...
,p_plug_query_headings_type=>'COLON_DELMITED_LIST'
,p_created_on=>wwv_flow_imp.dz('20260501141234Z')
,p_updated_on=>wwv_flow_imp.dz('20260506203840Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(165089895137985290461)
,p_region_id=>wwv_flow_imp.id(165089894783542290461)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(165089896802156290462)
,p_chart_id=>wwv_flow_imp.id(165089895137985290461)
,p_static_id=>'series'
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
...
'SELECT ',
'    CASE ',
'        WHEN suma <= 200 THEN ''Mici (sub 200 RON)''',
'        WHEN suma > 200 AND suma <= 700 THEN ''Medii (200 - 700 RON)''',
'        ELSE ''Mari (peste 700 RON)''',
'    END as segment_valoare,',
'    COUNT(id_cheltuiala) as numar_tranzactii',
'FROM cheltuieli',
'GROUP BY ',
'    CASE ',
'        WHEN suma <= 200 THEN ''Mici (sub 200 RON)''',
...
'    END'))
,p_max_row_count=>20
,p_items_value_column_name=>'NUMAR_TRANZACTII'
,p_items_label_column_name=>'SEGMENT_VALOARE'
,p_assigned_to_y2=>'off'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(165089895642939290461)
,p_chart_id=>wwv_flow_imp.id(165089895137985290461)
,p_static_id=>'x'
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(165089896259438290462)
,p_chart_id=>wwv_flow_imp.id(165089895137985290461)
,p_static_id=>'y'
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page(
 p_id=>2
,p_name=>unistr('Istoric Tranzac\021Bii')
,p_alias=>unistr('ISTORIC-TRANZAC\021AII')
,p_step_title=>unistr('Istoric Tranzac\021Bii')
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4072355960268175073
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
...
,p_created_on=>wwv_flow_imp.dz('20260506205210Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260507151401Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_last_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(166572660776458627935)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(166572661489956627936)
,p_plug_name=>unistr('Istoric Tranzac\021Bii')
,p_static_id=>unistr('istoric-tranzac\021Bii')
...
unistr('SELECT u.id_utilizator, -- am ad\0103ugat aceast\0103 coloan\0103'),
'       ch.id_cheltuiala,',
...
,p_plug_query_headings_type=>'COLON_DELMITED_LIST'
,p_prn_page_header=>unistr('Istoric Tranzac\021Bii')
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260506205211Z')
,p_updated_on=>wwv_flow_imp.dz('20260507150206Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(166572661511134627936)
...
,p_internal_uid=>166572661511134627936
,p_created_on=>wwv_flow_imp.dz('20260506205211Z')
,p_updated_on=>wwv_flow_imp.dz('20260507150206Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(165881959468112419507)
...
,p_created_on=>wwv_flow_imp.dz('20260506205757Z')
,p_updated_on=>wwv_flow_imp.dz('20260506205757Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(166572666036401628046)
,p_db_column_name=>'DATA_CHELTUIALA'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Data Cheltuiala'
,p_column_type=>'DATE'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260506205212Z')
,p_updated_on=>wwv_flow_imp.dz('20260506205212Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(166572664934270628043)
,p_db_column_name=>'ID_CHELTUIALA'
,p_display_order=>0
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
,p_column_label=>'Id Cheltuiala'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(165881959651832419509)
,p_db_column_name=>'ID_UTILIZATOR'
,p_display_order=>35
,p_column_identifier=>'H'
,p_column_label=>'Id Utilizator'
,p_column_type=>'NUMBER'
,p_display_text_as=>'HIDDEN_ESCAPE_SC'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260507133643Z')
,p_updated_on=>wwv_flow_imp.dz('20260507134712Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(166572666465516628046)
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260506205212Z')
,p_updated_on=>wwv_flow_imp.dz('20260506210634Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(165881959316874419506)
,p_db_column_name=>'UTILIZATOR'
,p_display_order=>15
,p_column_identifier=>'F'
,p_column_label=>'Utilizator'
,p_column_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:3:P3_ID_UTILIZATOR:#ID_UTILIZATOR#'
,p_column_linktext=>'#UTILIZATOR#'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260506205757Z')
,p_updated_on=>wwv_flow_imp.dz('20260507145543Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(166574039011063687030)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1665740391'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'ID_UTILIZATOR:UTILIZATOR:DATA_CHELTUIALA:SUMA:CATEGORIE:'
,p_created_on=>wwv_flow_imp.dz('20260506210201Z')
,p_updated_on=>wwv_flow_imp.dz('20260507150206Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(166844448771409167492)
,p_report_id=>wwv_flow_imp.id(166574039011063687030)
...
,p_operator=>'>'
,p_expr=>'700'
,p_condition_sql=>' (case when ("SUMA" > to_number(#APXWS_EXPR#)) then #APXWS_HL_ID# end) '
,p_condition_display=>'#APXWS_COL_NAME# > #APXWS_EXPR_NUMBER#  '
,p_enabled=>'Y'
,p_highlight_sequence=>10
,p_row_bg_color=>'#fc4b4b'
,p_created_on=>wwv_flow_imp.dz('20260507150206Z')
,p_updated_on=>wwv_flow_imp.dz('20260507150206Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
...
wwv_flow_imp_page.create_page(
 p_id=>3
,p_name=>unistr('Monitorizare Tranzac\021Bii Clien\021Bi')
,p_alias=>unistr('MONITORIZARE-TRANZAC\021AII-CLIEN\021AI')
,p_step_title=>unistr('Monitorizare Tranzac\021Bii Clien\021Bi')
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4072355960268175073
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
...
,p_created_on=>wwv_flow_imp.dz('20260507122258Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260507151322Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_last_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(166796763300916865925)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(166796764022403865926)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(166796800416032868438)
,p_plug_name=>'Cheltuieli Utilizator'
,p_static_id=>'cheltuieli-utilizator'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>30
,p_plug_item_display_point=>'ABOVE'
,p_query_type=>'TABLE'
,p_query_table=>'CHELTUIELI'
,p_include_rowid_column=>false
,p_plug_source_type=>'NATIVE_IG'
,p_master_region_id=>wwv_flow_imp.id(166796764811850865927)
,p_prn_page_header=>'Cheltuieli Utilizator'
,p_created_on=>wwv_flow_imp.dz('20260507122323Z')
,p_updated_on=>wwv_flow_imp.dz('20260507151322Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796802191871868440)
...
,p_updated_on=>wwv_flow_imp.dz('20260507122323Z')
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796801620290868440)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796806136226868445)
,p_name=>'DATA_CHELTUIALA'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DATA_CHELTUIALA'
,p_data_type=>'DATE'
,p_session_state_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_DATE_PICKER_APEX'
,p_heading=>'Data Cheltuiala'
,p_heading_alignment=>'LEFT'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796805191708868445)
,p_name=>'ID_CATEGORIE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID_CATEGORIE'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_SELECT_LIST'
,p_heading=>'Id Categorie'
,p_heading_alignment=>'LEFT'
...
'select denumire as d, id_categorie as r',
'from categorii WHERE denumire != ''Salariu''',
'order by 1'))
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796803194617868443)
,p_name=>'ID_CHELTUIALA'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID_CHELTUIALA'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
,p_is_query_only=>false
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796804135582868444)
,p_name=>'ID_UTILIZATOR'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID_UTILIZATOR'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_HIDDEN'
...
,p_enable_hide=>true
,p_is_primary_key=>false
,p_parent_column_id=>wwv_flow_imp.id(166796767626589865944)
,p_duplicate_value=>true
,p_include_in_export=>false
,p_updated_on=>wwv_flow_imp.dz('20260507122323Z')
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796807195005868446)
,p_name=>'SUMA'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(166796800818427868439)
,p_internal_uid=>166796800818427868439
,p_is_editable=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(166796801217732868440)
,p_interactive_grid_id=>wwv_flow_imp.id(166796800818427868439)
,p_static_id=>'1667968013'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(166796801457765868440)
,p_report_id=>wwv_flow_imp.id(166796801217732868440)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796802522873868441)
,p_view_id=>wwv_flow_imp.id(166796801457765868440)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(166796802191871868440)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796803548462868443)
,p_view_id=>wwv_flow_imp.id(166796801457765868440)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(166796803194617868443)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796804535453868444)
,p_view_id=>wwv_flow_imp.id(166796801457765868440)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(166796804135582868444)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796805569606868445)
,p_view_id=>wwv_flow_imp.id(166796801457765868440)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(166796805191708868445)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796806553882868446)
,p_view_id=>wwv_flow_imp.id(166796801457765868440)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(166796806136226868445)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796807537335868447)
,p_view_id=>wwv_flow_imp.id(166796801457765868440)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(166796807195005868446)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(166796764811850865927)
,p_plug_name=>unistr('Monitorizare Tranzac\021Bii Clien\021Bi')
,p_static_id=>unistr('monitorizare-tranzac\021Bii-clien\021Bi')
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>20
...
'       PRENUME,',
'       BUGET_LUNAR_MAXIM',
'  from UTILIZATORI WHERE (id_utilizator = :P3_ID_UTILIZATOR OR :P3_ID_UTILIZATOR IS NULL)'))
,p_plug_source_type=>'NATIVE_IG'
,p_ajax_items_to_submit=>'P3_ID_UTILIZATOR'
,p_prn_page_header=>unistr('Monitorizare Tranzac\021Bii Clien\021Bi')
,p_created_on=>wwv_flow_imp.dz('20260507122258Z')
,p_updated_on=>wwv_flow_imp.dz('20260507145347Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796766688561865929)
,p_name=>'APEX$ROW_ACTION'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_ACTION'
,p_label=>'Actions'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796766170991865929)
,p_name=>'APEX$ROW_SELECTOR'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_SELECTOR'
,p_display_sequence=>10
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796770664755865946)
,p_name=>'BUGET_LUNAR_MAXIM'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BUGET_LUNAR_MAXIM'
,p_data_type=>'NUMBER'
,p_session_state_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_NUMBER_FIELD'
,p_heading=>'Buget Lunar Maxim'
,p_heading_alignment=>'RIGHT'
,p_display_sequence=>60
,p_value_alignment=>'RIGHT'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796767626589865944)
,p_name=>'ID_UTILIZATOR'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID_UTILIZATOR'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796768627371865945)
,p_name=>'NUME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(166796769624344865945)
,p_name=>'PRENUME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(166796765302553865928)
,p_internal_uid=>166796765302553865928
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_lost_update_check_type=>'VALUES'
,p_add_row_if_empty=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(166796765795309865928)
,p_interactive_grid_id=>wwv_flow_imp.id(166796765302553865928)
,p_static_id=>'1667967658'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
,p_settings_area_expanded=>true
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(166796765995519865928)
,p_report_id=>wwv_flow_imp.id(166796765795309865928)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796767004853865930)
,p_view_id=>wwv_flow_imp.id(166796765995519865928)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(166796766688561865929)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796768080170865944)
,p_view_id=>wwv_flow_imp.id(166796765995519865928)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(166796767626589865944)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796769084434865945)
,p_view_id=>wwv_flow_imp.id(166796765995519865928)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(166796768627371865945)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796770018105865946)
,p_view_id=>wwv_flow_imp.id(166796765995519865928)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(166796769624344865945)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166796771054384865947)
,p_view_id=>wwv_flow_imp.id(166796765995519865928)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(166796770664755865946)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(166796764423409865927)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(166796764022403865926)
,p_button_name=>'SAVE'
,p_static_id=>'save'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(165881959707597419510)
,p_name=>'P3_ID_UTILIZATOR'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(166796764811850865927)
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260507145347Z')
,p_updated_on=>wwv_flow_imp.dz('20260507145347Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(166796808133553868447)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(166796800416032868438)
,p_process_type=>'NATIVE_IG_DML'
,p_process_name=>'Cheltuieli Utilizator - Save Interactive Grid Data'
,p_static_id=>'cheltuieli-utilizator-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
...
,p_process_when_button_id=>wwv_flow_imp.id(166796764423409865927)
,p_internal_uid=>166796808133553868447
,p_created_on=>wwv_flow_imp.dz('20260507122323Z')
,p_updated_on=>wwv_flow_imp.dz('20260507122323Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(166796771609054865947)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(166796764811850865927)
,p_process_type=>'NATIVE_IG_DML'
,p_process_name=>unistr('Monitorizare Tranzac\021Bii Clien\021Bi - Save Interactive Grid Data')
,p_static_id=>unistr('monitorizare-tranzac\021Bii-clien\021Bi-save-interactive-grid-data')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(166796764423409865927)
,p_internal_uid=>166796771609054865947
,p_created_on=>wwv_flow_imp.dz('20260507122258Z')
,p_updated_on=>wwv_flow_imp.dz('20260507122258Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_page(
 p_id=>4
,p_name=>'Administrare Sistem'
,p_alias=>'ADMINISTRARE-SISTEM'
,p_step_title=>'Administrare Sistem'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4072355960268175073
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(166851483233530967478)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165881959870398419511)
,p_plug_name=>'Categorii Cheltuieli'
,p_static_id=>'categorii-cheltuieli'
,p_title=>'Categorii Cheltuieli'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>10
,p_plug_item_display_point=>'ABOVE'
...
,p_prn_page_header=>'Categorii Cheltuieli'
...
,p_created_on=>wwv_flow_imp.dz('20260507152946Z')
,p_updated_on=>wwv_flow_imp.dz('20260507152947Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881961147835419524)
,p_name=>'APEX$ROW_ACTION'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_ACTION'
,p_display_sequence=>20
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881961203420419525)
,p_name=>'APEX$ROW_SELECTOR'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_SELECTOR'
,p_display_sequence=>10
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960190242419514)
,p_name=>'DENUMIRE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DENUMIRE'
,p_data_type=>'VARCHAR2'
,p_session_state_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_TEXT_FIELD'
...
,p_duplicate_value=>true
,p_include_in_export=>true
,p_updated_on=>wwv_flow_imp.dz('20260507152946Z')
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960025565419513)
,p_name=>'ID_CATEGORIE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID_CATEGORIE'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(165881959982724419512)
,p_internal_uid=>165881959982724419512
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_lost_update_check_type=>'VALUES'
,p_add_row_if_empty=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(166854671690397333531)
,p_interactive_grid_id=>wwv_flow_imp.id(165881959982724419512)
,p_static_id=>'1668546717'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
,p_settings_area_expanded=>true
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(166854672082872333531)
,p_report_id=>wwv_flow_imp.id(166854671690397333531)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854673955325333534)
,p_view_id=>wwv_flow_imp.id(166854672082872333531)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(165881960025565419513)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854674876379333536)
,p_view_id=>wwv_flow_imp.id(166854672082872333531)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(165881960190242419514)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854680595619333549)
,p_view_id=>wwv_flow_imp.id(166854672082872333531)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(165881961147835419524)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165881960296376419515)
,p_plug_name=>'Utilizatori'
,p_static_id=>'utilizatori'
,p_title=>'(Utilizatori System'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>20
,p_plug_item_display_point=>'ABOVE'
...
,p_prn_height=>8.5
,p_prn_orientation=>'HORIZONTAL'
,p_prn_page_header=>'(Utilizatori System'
,p_prn_page_header_font_color=>'#000000'
,p_prn_page_header_font_family=>'Helvetica'
,p_prn_page_header_font_weight=>'normal'
,p_prn_page_header_font_size=>'12'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960892418419521)
,p_name=>'APEX$ROW_ACTION'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_ACTION'
,p_display_sequence=>20
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960908633419522)
,p_name=>'APEX$ROW_SELECTOR'
,p_session_state_data_type=>'VARCHAR2'
,p_item_type=>'NATIVE_ROW_SELECTOR'
,p_display_sequence=>10
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960702810419520)
,p_name=>'BUGET_LUNAR_MAXIM'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BUGET_LUNAR_MAXIM'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960450300419517)
,p_name=>'ID_UTILIZATOR'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'ID_UTILIZATOR'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960547644419518)
,p_name=>'NUME'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'NUME'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(165881960695429419519)
,p_name=>'PRENUME'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'PRENUME'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(165881960359887419516)
,p_internal_uid=>165881960359887419516
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_lost_update_check_type=>'VALUES'
,p_add_row_if_empty=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(166854672807069333532)
,p_interactive_grid_id=>wwv_flow_imp.id(165881960359887419516)
,p_static_id=>'1668546729'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
,p_settings_area_expanded=>true
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(166854673023905333532)
,p_report_id=>wwv_flow_imp.id(166854672807069333532)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854675773196333538)
,p_view_id=>wwv_flow_imp.id(166854673023905333532)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(165881960450300419517)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854676687217333540)
,p_view_id=>wwv_flow_imp.id(166854673023905333532)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(165881960547644419518)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854677542676333542)
,p_view_id=>wwv_flow_imp.id(166854673023905333532)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(165881960695429419519)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854678464534333544)
,p_view_id=>wwv_flow_imp.id(166854673023905333532)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(165881960702810419520)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(166854679258343333546)
,p_view_id=>wwv_flow_imp.id(166854673023905333532)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(165881960892418419521)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(165881961310658419526)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(165881959870398419511)
,p_process_type=>'NATIVE_IG_DML'
,p_process_name=>'Categorii Cheltuieli - Save Interactive Grid Data'
,p_static_id=>'categorii-cheltuieli-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
  'target_type', 'REGION_SOURCE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>165881961310658419526
,p_created_on=>wwv_flow_imp.dz('20260507152946Z')
,p_updated_on=>wwv_flow_imp.dz('20260507152946Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(165881961074930419523)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(165881960296376419515)
,p_process_type=>'NATIVE_IG_DML'
,p_process_name=>'Utilizatori - Save Interactive Grid Data'
,p_static_id=>'utilizatori-save-interactive-grid-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
  'target_type', 'REGION_SOURCE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>165881961074930419523
,p_created_on=>wwv_flow_imp.dz('20260507152946Z')
,p_updated_on=>wwv_flow_imp.dz('20260507152946Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
,p_name=>'Login Page'
,p_alias=>'LOGIN'
,p_step_title=>'Personal Budget Manager - Log In'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(165087591833131204768)
,p_plug_name=>'Personal Budget Manager'
,p_static_id=>'personal-budget-manager'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(165087593543701204771)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(165087591833131204768)
,p_button_name=>'LOGIN'
,p_static_id=>'login'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(165087592765446204770)
,p_name=>'P9999_PASSWORD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(165087591833131204768)
,p_prompt=>'Password'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(165087593113474204771)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(165087592343470204769)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(165087597663470204776)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>165087597663470204776
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(165087597247491204774)
,p_process_sequence=>10
...
,p_internal_uid=>165087597247491204774
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(165087593862438204772)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>165087593862438204772
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(165087594873862204773)
,p_page_process_id=>wwv_flow_imp.id(165087593862438204772)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(165087595305937204773)
,p_page_process_id=>wwv_flow_imp.id(165087593862438204772)
,p_page_id=>9999
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(165087594344580204772)
,p_page_process_id=>wwv_flow_imp.id(165087593862438204772)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(165087595771526204773)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'type', 'PLSQL_PACKAGE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>165087595771526204773
,p_created_on=>wwv_flow_imp.dz('20260501135817Z')
,p_updated_on=>wwv_flow_imp.dz('20260501135817Z')
,p_created_by=>'PLAMUTIELENA24@STUD.ASE.RO'
,p_updated_by=>'PLAMUTIELENA24@STUD.ASE.RO'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(165087596709158204774)
,p_page_process_id=>wwv_flow_imp.id(165087595771526204773)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
,p_data_type=>'BOOLEAN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(165087596226798204774)
,p_page_process_id=>wwv_flow_imp.id(165087595771526204773)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
